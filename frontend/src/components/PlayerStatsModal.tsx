...
export function PlayerStatsModal({
  ...
  const { characterProgressions, isLoading: isLoadingProgressions } =
    useCharacterProgressions();
              ...
              <TabsContent value="stats" className="space-y-6 pb-6 mt-0">
                ...
                <div>
                  ...
                  {(() => {
                    ...
                    // Group contacts by financial stage using real progression data
                    const stageDistribution = characterProgressions.reduce(
                      (acc, progression) => {
                        // Use REAL financial stage from character data
                        const stage =
                          progression.financialState?.currentStage ?? 0;
                        ...
                        <div>
                          ...
                          <div className="space-y-3">
                            {characterProgressions
                              .filter((p) => p.financialState)
                              .slice(0, 5)
                              .map((progression) => {
                                const fs = progression.financialState!;
                                const initialNetWorth =
                                  fs.netWorthHistory?.[0]?.amount || 0;
                                const netWorthGrowth =
                                  fs.netWorth - initialNetWorth;
                                const growthPercentage =
                                  initialNetWorth > 0
                                    ? (
                                        (netWorthGrowth / initialNetWorth) *
                                        100
                                      ).toFixed(1)
                                    : "N/A";

                                // Success path names
                                const successPathNames: Record<
                                  SuccessPath,
                                  string
                                > = {
                                ...
                                return (
                                  ...
                                  >
                                    ...
                                    <div className="mb-2">
                                      ...
                                      >
                                        €{fs.monthlyIncome.toLocaleString()}
                                      </span>
                                    </div>

                                    {/* Success Path */}
                                    {fs.selectedSuccessPath && (
                                      <div className="mb-2">
                                        <span
                                          style={{
                                            fontSize: "var(--text-xs)",
                                    ...
                                    <div className="mb-2">
                                      <div className="flex justify-between mb-1">
                                        ...
                                        >
                                          {fs.readyForNextStage
                                            ? "Ready!"
                                            : `${fs.monthsInCurrentStage} months`}
                                        </span>
                                      </div>
                                      <div
                                        className="w-full h-2 rounded-full"
                                      ...
                                      >
                                        <div
                                          className="h-full rounded-full transition-all"
                                          style={{
                                            width: `${fs.readyForNextStage ? 100 : Math.min(fs.monthsInCurrentStage * 10, 100)}%`,
                                            backgroundColor:
                                              fs.readyForNextStage
                                                ? "var(--chart-1)"
                                                : "var(--chart-3)",
                          ...
                          {characterProgressions.length === 0 && (
                            <p
                              style={{
                                fontSize: "var(--text-sm)",
                                color: "var(--muted-foreground)",
                            ...
                            >
                              {isLoadingProgressions
                                ...
                                : "No client data yet. Complete consultations to track progress."}
                            </p>
                          )}
                        </div>
                      </div>
                    ...
                    <div>
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        ...
                        >
                          ...
                          >
                            {analytics.performance.overallSuccessRate.toFixed(
                              1,
                            )}
                            %
                          </p>
                        ...
                        >
                          ...
                          >
                            {analytics.performance.averageQualityScore.toFixed(
                              1,
                            )}
                            /10
                          </p>
                            ...
                            >
                              ...
                              <div className="flex gap-4 text-sm">
                                <span style={{ color: "var(--chart-1)" }}>
                                  💰 €{topic.totalSavings.toLocaleString()}{" "}
                                  saved
                                </span>

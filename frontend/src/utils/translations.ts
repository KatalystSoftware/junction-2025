...
const translations: Record<Language, Translations> = {
  en: {
    ...
    onboarding: {
      ...
      pickAvatar: "Pick your avatar as a financial advisor.",
      yourName: "Your Name",
      enterName: "Enter your name",
      yourAvatar: "Your Avatar",
      preferredLanguage: "Preferred Language",
      welcomeTitle: "Welcome to Broke No More!",
      welcomeSubtitle: "Save the town, one bad idea at a time",
      welcomeDescription:
        "Chat with clients, give advice, see results. Good advice builds trust and changes lives.",
      readyTitle: "Ready to Save the Day?",
      readySubtitle: "Your boss is waiting",
      readyDescription:
        "Michael Scott needs you. Help clients avoid financial disasters. Be smart, be empathetic, and watch the town prosper.",
      features: {
        chatNaturally: "Give advice via chat (like WhatsApp)",
        buildTrust: "Build trust, unlock new clients",
        helpProgress: "See real financial impact from your advice",
      },
      startJourney: "Let's Go!",
      pressKeys: "Press",
      or: "or",
    },
    ...
    onboarding: {
      ...
      pickAvatar: "Valitse avatarisi taloudellisena neuvonantajana.",
      yourName: "Nimesi",
      enterName: "Kirjoita nimesi",
      yourAvatar: "Avatarisi",
      preferredLanguage: "Ensisijainen Kieli",
      welcomeTitle: "Tervetuloa Broke No More!",
      welcomeSubtitle: "Pelasta kaupunki, yksi huono idea kerrallaan",
      welcomeDescription:
        "Keskustele asiakkaiden kanssa, anna neuvoja, näe tulokset. Hyvät neuvot rakentavat luottamusta ja muuttavat elämää.",
      readyTitle: "Valmiina Pelastamaan Päivän?",
      readySubtitle: "Pomosi odottaa",
      readyDescription:
        "Michael Scott tarvitsee sinua. Auta asiakkaita välttämään talouskatastrofeja. Ole fiksu, ole empaattinen, ja katso kaupungin kukoistavan.",
      features: {
        chatNaturally: "Anna neuvoja chatin kautta (kuten WhatsApp)",
        buildTrust: "Rakenna luottamusta, avaa uusia asiakkaita",
        helpProgress: "Näe neuvojesi todellinen taloudellinen vaikutus",
      },
      startJourney: "Mennään!",
      pressKeys: "Paina",
      or: "tai",
    },
  ...
  sv: {
    ...
    onboarding: {
      ...
      pickAvatar: "Välj din avatar som finansiell rådgivare.",
      yourName: "Ditt Namn",
      enterName: "Ange ditt namn",
      yourAvatar: "Din Avatar",
      preferredLanguage: "Föredraget Språk",
      welcomeTitle: "Välkommen till Broke No More!",
      welcomeSubtitle: "Rädda staden, en dålig idé i taget",
      welcomeDescription:
        "Chatta med klienter, ge råd, se resultat. Goda råd bygger förtroende och förändrar liv.",
      readyTitle: "Redo Att Rädda Dagen?",
      readySubtitle: "Din chef väntar",
      readyDescription:
        "Michael Scott behöver dig. Hjälp klienter undvika finansiella katastrofer. Var smart, var empatisk och se staden blomstra.",
      features: {
        chatNaturally: "Ge råd via chatt (som WhatsApp)",
        buildTrust: "Bygg förtroende, lås upp nya klienter",
        helpProgress: "Se verklig finansiell påverkan från dina råd",
      },
      startJourney: "Vi kör!",
      pressKeys: "Tryck",
      or: "eller",
